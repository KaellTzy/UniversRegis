      ...
      <ul id="sidebarnav">
        ...
        @if (Auth::user()->role === 'admin')
          ...
          <li class="sidebar-item">
            ...
            href="{{ route('admin.peserta.index') }}" aria-expanded="false">
            <span>
              <i class="ti ti-user-circle"></i>
            </span>
            <span class="hide-menu">Manage Akun Peserta</span>
            </a>
          </li>

          <li class="sidebar-item">
            <a class="sidebar-link {{ request()->routeIs('admin.provinsi.*') ? 'active' : '' }}"
            href="{{ route('admin.provinsi.index') }}" aria-expanded="false">
            <span>
              <i class="ti ti-map"></i>
            </span>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link {{ request()->routeIs('admin.kota.*') ? 'active' : '' }}"
            href="{{ route('admin.kota.index') }}" aria-expanded="false">
            <span>
